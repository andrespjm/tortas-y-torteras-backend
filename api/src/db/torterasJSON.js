export default JSON.parse(
	JSON.stringify({
		...
		Colors: [
			...
			{ name: 'water green', hex: '#03bb85' },
		],
		ProductType: [
			{ name: 'Cake Tray', diameter: '32' },
			{ name: 'Turntable', diameter: '35' },
		],
		Users: [
			{
				...
				gender: 'Male',
				email: 'juanperez@world.com',
				identityCard: '25122022',
				profilePicture:
					'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmVfdYfsGUaxzQV6OGxW_fnrlmTfO2bAWDjw&usqp=CAU',
			...
			},
			{
				...
				gender: 'Male',
				email: 'marcossosa@world.com',
				identityCard: '24300200',
				profilePicture:
